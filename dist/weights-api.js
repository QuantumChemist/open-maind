...
class WeightsApi {
    constructor(apiKey, endpoint = null) {
        ...
        this.getStatus = async (params) => {
            return this.callWithHealthCheck(() => this.apiCall("/status/" + params.imageId, HttpMethod.GET).then((response) => response.json()));
        };
        /**
         ...
         */
        this.getQuota = async () => {
            return this.callWithHealthCheck(() => this.apiCall("/quota", HttpMethod.GET).then((response) => response.text()));
        };
        /**
        ...
        this.searchLoras = async (params) => {
            return this.callWithHealthCheck(() => this.apiCall("/search-loras", HttpMethod.GET, params).then((response) => response.json()));
        };
        /**
        ...
        this.generateImage = async (params) => {
            return this.callWithHealthCheck(() => this.apiCall("/generateImage", HttpMethod.GET, params).then((response) => response.json()));
        };
        /**
     ...
     */
    async apiCall(path, method = HttpMethod.GET, body = null) {
        const options = {
            method,
            headers: {
